...
namespace ChinarConsole
{
    ...
    class LogConsole : MonoBehaviour
    {
        ...
        private const string ChinarWindowTitle = "System Log";
        ...
        Rect windowRect = new Rect((Screen.width/8), Screen.height/6, 6*(Screen.width / 8), 4*(Screen.height / 6));
        ...
        void DrawLogsList()
        {
            ...
            for (var i = 0; i < logs.Count; i++)
            {
                ...
                if (logs[i].LogType != LogType.Log) continue;
